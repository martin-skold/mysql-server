...
Dbqvctr::Dbqvctr(Block_context &ctx, Uint32 instanceNumber)
    : Dbvctr(ctx, instanceNumber, DBQVCTR) {}

Uint64 Dbqvctr::getTransactionMemoryNeed() {
  Uint32 query_instance_count =
      globalData.ndbMtQueryThreads + globalData.ndbMtRecoverThreads;
  Uint64 scan_op_byte_count = 1;
  Uint32 vctr_scan_recs = 1;
  Uint32 vctr_scan_lock_recs = 1;
