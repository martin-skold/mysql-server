...
#define CFG_VCTR_INDEX (PRIVATE_BASE + 97)
#define CFG_VCTR_FRAGMENT (PRIVATE_BASE + 98)
#define CFG_VCTR_ATTRIBUTE (PRIVATE_BASE + 99)
#define CFG_VCTR_SCAN_OP (PRIVATE_BASE + 100)
#define CFG_VCTR_RESERVED_SCAN_RECORDS (PRIVATE_BASE + 101)
