 ...
 */
void Dbvctr::findNodeToUpdate(VctrCtx &ctx, Frag &frag,
 ...
 */
bool Dbvctr::findPosToAdd(VctrCtx &ctx, Frag &frag,
 ...
 */
bool Dbvctr::findPosToRemove(VctrCtx &ctx, TreeEnt searchEnt,
                            NodeHandle &currNode, TreePos &treePos) {
 ...
 * Can be called from MT-build of ordered indexes.
 */
bool Dbvctr::searchToAdd(VctrCtx &ctx, Frag &frag,
                        const KeyBoundArray &searchBound, TreeEnt searchEnt,
                        TreePos &treePos) {
 ...
 */
bool Dbvctr::searchToRemove(VctrCtx &ctx, Frag &frag,
                           const KeyBoundArray &searchBound, TreeEnt searchEnt,
                           TreePos &treePos) {
  const TreeHead &tree = frag.m_tree;
  NodeHandle currNode(frag);
 ...
 */
void Dbvctr::findNodeToScan(Frag &frag, unsigned idir,
                           const KeyBoundArray &searchBound,
                           NodeHandle &currNode) {
 ...
 */
void Dbvctr::findPosToScan(Frag &frag, unsigned idir,
                          const KeyBoundArray &searchBound,
 ...
 */
void Dbvctr::searchToScan(Frag &frag, unsigned idir,
