...
#define RT_DBVCTR_SCAN_OPERATION MAKE_TID(34, RG_TRANSACTION_MEMORY)
#define RT_DBVCTR_SCAN_LOCK MAKE_TID(35, RG_TRANSACTION_MEMORY)
#define RT_DBVCTR_SCAN_BOUND MAKE_TID(36, RG_TRANSACTION_MEMORY)
